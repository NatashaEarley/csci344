...
// const getImg = (statarray) => {
//     const getImg = item => item.image_url;
//     return statarray.map(getImg);
// }

// console.log(getImg(statuses));

// Watch video on it?


function getImg(statArray) {
    return statArray.map(objToImg).filter(filterOut);
}

function objToImg(item) {
